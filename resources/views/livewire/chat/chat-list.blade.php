<div>
    ...
    <div class="chatlist_body scroll">
        @foreach ($users_without_conversation as $user)
            <div class="chatlist_item" wire:key="{{ $user->id }}"
                wire:click="createNewConversation({{ $user->id }})">
                ...
                <div class="chatlist_info">
                    <div class="top_row">
                        <div class="list_username">{{ ucFirst($user->name) }}</div>
                    </div>
                </div>
            </div>
        @endforeach
